...
public class ConsoleCollection implements Console{
    ...
    public void startMainMenu(){
        ...
        Room room0 = new Room(CategoryFacility.ROOM.getTypeName(), "11",100,1, RoomLevel.STANDART.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom0 = new FreeRoom(room0, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom in CONSTRUCTOR
        facilityController.create(room0);
        roomReservationController.createFreeRoom(freeRoom0);
        Room room1 = new Room(CategoryFacility.ROOM.getTypeName(), "12",120,2,RoomLevel.ECONOM.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom1 = new FreeRoom(room1, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room1);
        roomReservationController.createFreeRoom(freeRoom1);
        Room room2 = new Room(CategoryFacility.ROOM.getTypeName(), "13",150,2,RoomLevel.LUX.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom2 = new FreeRoom(room2, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room2);
        roomReservationController.createFreeRoom(freeRoom2);
        Room room3 = new Room(CategoryFacility.ROOM.getTypeName(), "21",100,1,RoomLevel.STANDART.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom3 = new FreeRoom(room3, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room3);
        roomReservationController.createFreeRoom(freeRoom3);
        Room room4 = new Room(CategoryFacility.ROOM.getTypeName(), "22",120,2,RoomLevel.ECONOM.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom4 = new FreeRoom(room4, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room4);
        roomReservationController.createFreeRoom(freeRoom4);
        Room room5 = new Room(CategoryFacility.ROOM.getTypeName(), "23",150,2,RoomLevel.LUX.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom5 = new FreeRoom(room5, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room5);
        roomReservationController.createFreeRoom(freeRoom5);
        Room room6 = new Room(CategoryFacility.ROOM.getTypeName(), "31",110,1,RoomLevel.STANDART.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom6 = new FreeRoom(room6, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room6);
        roomReservationController.createFreeRoom(freeRoom6);
        Room room7 = new Room(CategoryFacility.ROOM.getTypeName(), "32",140,2,RoomLevel.ECONOM.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom7 = new FreeRoom(room7, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room7);
        roomReservationController.createFreeRoom(freeRoom7);
        Room room8 = new Room(CategoryFacility.ROOM.getTypeName(), "33",160,2,RoomLevel.LUX.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom8 = new FreeRoom(room8, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room8);
        roomReservationController.createFreeRoom(freeRoom8);
        Room room9 = new Room(CategoryFacility.ROOM.getTypeName(), "41",400,4,RoomLevel.LUX.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom9 = new FreeRoom(room9, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        facilityController.create(room9);
        roomReservationController.createFreeRoom(freeRoom9);
        Room room10 = new Room(CategoryFacility.ROOM.getTypeName(), "42",400,4,RoomLevel.LUX.getLevel(), RoomStatus.AVAILABLE.getStatus());
        FreeRoom freeRoom10 = new FreeRoom(room10, START_DATE_YEAR, END_DATE_YEAR); // create automatic changing IDfreeRoom
        ...
        RoomReservation roomReservation1 = new RoomReservation(guestController.read(1),
        ...
        RoomReservation roomReservation2 = new RoomReservation(guestController.read(1),
        ...
        RoomReservation roomReservation3 = new RoomReservation(guestController.read(1),
        ...
        RoomReservation roomReservation4 = new RoomReservation(guestController.read(1),
        ...
        RoomReservation roomReservation5 = new RoomReservation(guestController.read(5),
        ...
        RoomReservation roomReservation6 = new RoomReservation(guestController.read(6),
        ...
        RoomReservation roomReservation7 = new RoomReservation(guestController.read(7),
        ...
        RoomReservation roomReservation8 = new RoomReservation(guestController.read(8),
        ...
        RoomReservation roomReservation9 = new RoomReservation(guestController.read(9),
