...
public class ExecutorAnalyticsDB implements Executor {
    ...
    public void execute(int menuPoint) throws IllegalAccessException, InvocationTargetException, NoSuchMethodException, InstantiationException {
        ...
        switch (menuPoint) {
            case 1: // ready
                log.info(CONSOLE_READ_ALL_ROOMS_SORTED_BY_PRICE, facilityController.readAllRoomsSortByPrice());
                break;
            case 2: // ready
                log.info(CONSOLE_READ_ALL_ROOMS_SORTED_BY_CAPACITY, facilityController.readAllRoomsSortByCapacity());
                break;
            case 3: // ready
                log.info(CONSOLE_READ_ALL_ROOMS_SORTED_BY_LEVEL, facilityController.readAllRoomsSortByLevel());
                break;
            case 4: // ready
            ...
            case 6: // ready
                ...
                break;
            case 7: // ready
                log.info(CONSOLE_READ_ALL_ROOM_RESERVATIONS_SORTED_BY_GUEST_NAME,
                        roomReservationController.readAllRoomReservationsSortByGuestName());
                break;
            case 8: // ready
                log.info(CONSOLE_READ_ALL_ROOM_RESERVATIONS_SORTED_BY_CHECK_OUT,
            ...
            case 9:
                ...
                break;
            case 10: // ready
                log.info(CONSOLE_NUMBER_GUEST_TOTAL, guestController.countNumberOfGuestsTotal());
                break;
            case 11: // ready
            ...
            case 14: // ready
                ...
                break;
            case 15:
                log.info(CONSOLE_READ_ALL_SERVICES_SORTED_BY_PRICE,
                        roomReservationController.readAllServicesSortByPrice());
                break;
            case 16:
                log.info(CONSOLE_READ_ALL_SERVICES_SORTED_BY_DATE,
                        roomReservationController.readAllServicesSortByDate());
                break;
            case 17:
                log.info(CONSOLE_READ_ALL_FACILITIES_SORTED_BY_CATEGORY,
                        facilityController.readPriceListForServicesSortByCategory());
                break;
            case 18:
                log.info(CONSOLE_READ_ALL_FACILITIES_SORTED_BY_PRICE,
