...
public class RoomReservationConstant {
    ...
    public static final String ALL_ROOM_RESERVATION_IS_EMPTY = "There are no any Room's Reservations.\n" +
    ...
    public static final String ROOM_RESERVATION_NOT_EXISTS =     "There is no such Room's reservation.";
}
